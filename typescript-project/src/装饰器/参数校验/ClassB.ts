...
class MyClass {
    sendSuccessCallback(...msg: any) {
        console.log('=======sendSuccessCallback=====', ...msg)
    }
    ...
    method(
        ...
        arg2: any,
        @Rule({ customValidator: (v) => v > 10, message: "arg3 is less then 10" })
        arg3?: any,
        @Rule({
            type: "object",
            properties:
        ...
        this.sendSuccessCallback('MyClass.method', arg1, arg2, arg3, arg4);
    }
}

const myClass = new MyClass();
myClass.method(123, 'abc', 20, { name: '1' }); // 正常执行
myClass.method(123, 'abc', 15, { name: 1 }, (e: any) => { console.warn(e) }); // 抛出类型错误
